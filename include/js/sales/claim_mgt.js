...
$(function () {
    ...
    let grid01 = {
        ...
        columns: [
            ...
            { field: 'ship_cd', caption: '출고처현장코드', size: '150px', sortable: true, resizable: true},
    ...
    pop_ship_cd.AddParentReferGridTag(["cmpny_cd","biz_cd","biz_nm"],["cmpny_cd","biz_cd","biz_nm"]);
