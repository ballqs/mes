...
export default class Pop_prt_nbr_cd_wp extends PopupGridPageManager{



    constructor(caller_instance, parent_search_frm) {
        let popup_name = "pop_prt_nbr_cd_wp";
        let search_frm_id = "pop_search_frm";
        let btn_frm_id = "pop_btn_frm";
        super(popup_name, search_frm_id, btn_frm_id, caller_instance, parent_search_frm);
        ...
        let grid_obj = {
            ...
            columns: [
                ...
                {field: 'fact_cd', caption: '공장코드', size: '100px', sortable: true, resizable: true, hidden: false, editable: {type: 'select'}},
                {field: 'fact_nm', caption: '공장명', size: '100px', sortable: true, resizable: true, hidden: true},
                ...
                {field: 'account_type_nm', caption: '계정유형명', size: '100px', sortable: true, resizable: true, hidden: true},
                {field: 'base_unit', caption: '기준단위', size: '100px', sortable: true, resizable: true, hidden: true},
                {field: 'base_unit_nm', caption: '기준단위', size: '100px', sortable: true, resizable: true, hidden: true},
            ],
        };
        let content_html = {
            title: '품번 코드',
            ...
            body: `
                    ...
                    <div id="${grid_obj.name}" style="position: absolute; left: 0; top: 148px; right: 0; bottom: 0;"></div>
                    `
            ,
            buttons:
