...
$(function(){
    let popup_id = "popup_bad_status";
    let form_id = "popup_bad_status_frm";
    let form_name = "popup_bad_status_frm";
    let callbackFnc = {
        pre : function(){
    ...
    let get_url = "/ajax/production/status/get/bad_status";
    let key_col = 'lotno';
    let table_arr_bad = ['prt_nbr_no', 'prt_nbr_nm', 'cd_nm', 'err_nm', 'err_qty', 'updt_dt'];

    let table_bad = new tableManager("#table_bad_status");
    table_bad.set_class(['','','','','text_r','text_c']);
