    ...
    */
    let grid02 = {
        ...
        columns: [
            ...
            { field: 'po_qty', caption: '발주수량', size: '100px', sortable: true, resizable: true, editable: { type: 'int'}, style: 'text-align: right;'},
            ...
            { field: 'po_staus_cd', caption: '발주상태', size: '100px', sortable: true, resizable: true, editable: { type: 'select' },style: 'text-align: center;'},
            { field: 'apval_yn', caption: '승인여부', size: '100px', sortable: true, resizable: true , style: 'text-align: center;'},
        ...
        fncPreSavePage : function(){
            ...
            for(let item of getChange){
                if(item['po_qty'] <= 0){
                    $(".loadingW").css("display", "none");
                    mes_alert({msg:"발주수량은 0 또는 0 이하로 저장할수없습니다."});
                    return {result : false};
                }
            }
            return {result : true};
        ...
        fncPreApprove : function (param) {
            console.log(param);
            $("#search_frm [name='po_no']").val(param[0]['po_no']);
            return {result : true};
        }
