...
//     pop_prt_nbr_cd.AddParentReferFormTag(["prt_nbr_cd", "prt_nbr_nm"], ["prt_nbr_cd", "prt_nbr_nm"]);
    ...
    //버튼에 대한 Ajax 경로
    pageManager.gridManager.SetAjaxUrl(grid02.name, Const.MesButton.Search, "/ajax/material/input/get/directpurchininfo_biz_ver");
...
//         console.log('this', this);
    ...
    function refresh(){
        $.ajax({
            url: "/ajax/material/input/get/directpurchininfo_biz_ver",
            type: "get",
    ...
    $("#hBtnB0005").on("click", function(obj){
        ...
        let ajax_url = "/ajax/material/input/save/mtrl_direct_input_mgt_biz_ver";
    ...
    $("#hBtnB0004").on("click", function(obj){
        w2confirm(Const.MesMsg.confirm)
            .yes(() => {
                $(".loadingW").css("display", "");
                let param = common.get_last_clicked_row();
                let ajax_url = "/ajax/material/input/delete/mtrl_direct_input_mgt_biz_ver";
//                 param['data'] = FormHelper.SerializeForm("detail_frm");
