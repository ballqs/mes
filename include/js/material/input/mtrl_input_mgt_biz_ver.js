...
$(function () {
    ...
    let grid01 = {
        ...
        rowOnClickConfig : {
            ...
            [Const.config.rowOnClickConfig.url] : "/ajax/material/input/get/purchininfo_biz_ver"
        },
        lastGetParam : {
            param : {},
        },
    ...
    //버튼에 대한 Ajax 경로
    pageManager.gridManager.SetAjaxUrl(grid01.name, Const.MesButton.Search, "/ajax/material/input/get/purchinfo_biz_ver");
...
//         }
        ...
        document.detail_frm.lotno.value = (clicked_rec.lotno == null) ? '*' : clicked_rec.lotno;
...
//     $("#hBtnB0005, #hBtnB0004").on("click", function(obj){
    $("#hBtnB0005").on("click", function(obj){
        ...
        let ajax_url = "/ajax/material/input/save/mtrl_input_mgt_biz_ver";
    ...
    $("#hBtnB0004").on("click", function(obj){
        w2confirm(Const.MesMsg.confirm)
            .yes(() => {
                ...
                // });
                let param = common.get_last_clicked_row();
                let ajax_url = "/ajax/material/input/delete/mtrl_input_mgt_biz_ver";
//                 param['data'] = FormHelper.SerializeForm("detail_frm");
