...
$(function () {
    ...
    let grid02 = {  // tpa_purchininfo 그대로 보여주면됨. del_yn 제외
        ...
        columns: [
            ...
            { field: 'prt_nbr_cd', caption: '품번코드', size: '120px', sortable: true, resizable: true, hidden: false},
            ...
            { field: 'po_in_unit', caption: '발주입고단위코드', size: '100px', sortable: true, resizable: true, hidden: true},
            ...
            { field: 'in_qty', caption: '입고수량', size: '100px', sortable: true, resizable: true },
            { field: 'in_whs_cd', caption: '입고창고코드', size: '100px', sortable: true, resizable: true },
            { field: 'whs_nm', caption: '입고창고명', size: '100px', sortable: true, resizable: true },
            { field: 'in_loc_cd', caption: '입고위치코드', size: '100px', sortable: true, resizable: true },
            { field: 'loc_nm', caption: '입고위치명', size: '100px', sortable: true, resizable: true },
            { field: 'po_no', caption: '발주번호', size: '150px', sortable: true, resizable: true },
            { field: 'po_seq', caption: '발주순번', size: '100px', sortable: true, resizable: true },
    ...
    // pop_prt_nbr_cd.AddParentReferGridTag(["prt_nbr_cd","prt_nbr_nm"], ["prt_nbr_cd","prt_nbr_nm"]);
...
//     pop_prt_nbr_cd.AddParentReferFormTag(["prt_nbr_cd", "prt_nbr_nm"], ["prt_nbr_cd", "prt_nbr_nm"]);
    ...
    let detail_pop_biz_cd = new Pop_biz_cd(pageManager, detail_frm_id, "detail_pop_biz_cd");
//     pop_prt_nbr_cd.AddParentReferFormTag(["prt_nbr_cd", "prt_nbr_nm"], ["prt_nbr_cd", "prt_nbr_nm"]);

    detail_pop_prt_nbr_cd.RegisterCallbackFunction({
        post: (obj) => {
            // this.options[this.selectedIndex].innerHTML
            let txt = document.search_frm.fact_cd.options[document.search_frm.fact_cd.selectedIndex].innerHTML;
            let val = document.search_frm.fact_cd.value;
            $("#pop_search_frm input[name='fact_cd']").val(val);
            $("#pop_search_frm input[name='fact_cd_nm']").val(txt);
        }
    });
    ...
    //버튼에 대한 Ajax 경로
    pageManager.gridManager.SetAjaxUrl(grid02.name, Const.MesButton.Search, "/ajax/material/input/get/directpurchininfo");
//     pageManager.gridManager.SetAjaxUrl(grid02.name, Const.MesButton.DeleteRow, "/ajax/material/input/delete/mtrl_input_mgt");
    ...
    pageManager.frmManager.AddPopupLink(detail_frm_id, caller_name, detail_pop_biz_cd.ShowFormDialog, target_name, from_name);
...
//         console.log('this', this);
    ...
    function refresh(){
        $.ajax({
            url: "/ajax/material/input/get/directpurchininfo",
            type: "get",
    ...
    $("#hBtnB0005").on("click", function(obj){
        ...
        let ajax_url = "/ajax/material/input/save/mtrl_direct_input_mgt";
    ...
    $("#hBtnB0004").on("click", function(obj){
        w2confirm(Const.MesMsg.confirm)
            .yes(() => {
                $(".loadingW").css("display", "");
                let param = common.get_last_clicked_row();
                let ajax_url = "/ajax/material/input/delete/mtrl_direct_input_mgt";
//                 param['data'] = FormHelper.SerializeForm("detail_frm");
