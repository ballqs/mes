...
$(function () {
    let grid01 = {
        ...
        columns: [
            ...
            { field: 'prt_nbr_cd', caption: '품번코드', size: '100px', sortable: true, resizable: true, hidden: true},
            ...
            { field: 'cd_nm', caption: '단위', size: '150px', sortable: true, resizable: true },
            ...
            { field: 'out_biz_nm', caption: '출고처', size: '150px', sortable: true, resizable: true, hidden: true },
            { field: 'out_ship_cd', caption: '출고처현장코드', size: '150px', sortable: true, resizable: true , hidden: true},
            { field: 'out_ship_nm', caption: '출고처현장', size: '150px', sortable: true, resizable: true, hidden: true },
...
//             $("#search_frm [name = 'prt_nbr_nm']").val((this.lastGetParam.param.like['prt_nbr_nm'] == null) ? '' : this.lastGetParam.param.like['prt_nbr_nm']);
    ...
    let grid02 = {  // tpa_purchininfo 그대로 보여주면됨. del_yn 제외
        ...
        columns: [
            ...
            { field: 'prt_nbr_cd', caption: '품번코드', size: '100px', sortable: true, resizable: true, hidden: true},
            { field: 'lotno', caption: 'lotno', size: '150px', sortable: true, resizable: true, hidden: true},
    ...
    let pop_ship_cd = new Pop_ship_cd(pageManager, detail_frm_id);
...
//         }
        ...
        document.detail_frm.biz_cd.value = clicked_rec.out_biz_cd;
        document.detail_frm.biz_nm.value = clicked_rec.out_biz_nm;
...
//                 common.draw_select(frm_name, "in_whs_cd", res.data, 'whs_cd', 'whs_nm');
//             });
//             let in_whs_cd = (added_row.in_whs_cd ? added_row.in_whs_cd : (added_row.inspct_yn ? "W0001" : "W0002"));
//             let in_whs_nm = (added_row.whs_nm ? added_row.whs_nm : (added_row.inspct_yn ? "검사대기창고" : "원자재창고"));
//             $(document.detail_frm.in_whs_cd).html("<option value="+in_whs_cd+">"+in_whs_nm+"</option>");
