...
$(function () {
    let grid01 = {
        ...
        columns: [
            ...
            { field: 'out_no', caption: '출고번호', size: '100px', sortable: true, resizable: true, style: 'text-align: right'},
            ...
            { field: 'lotno', caption: 'LOT NO', size: '100px', sortable: true, resizable: true},
    ...
    pageManager.gridManager.SetAjaxUrl(grid01.name, Const.MesButton.Search, "/ajax/material/output/get/term_output_staus");
