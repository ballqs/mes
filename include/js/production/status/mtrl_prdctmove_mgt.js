...
$(function () {
    let grid01 = {
        ...
        rowOnClickConfig : {
            ...
            [Const.config.rowOnClickConfig.clickWhereFieldList] : ["fact_cd", "prt_nbr_cd", "prt_nbr_nm", "lotno", "stck_whs_cd", "stck_loc_cd"],
            [Const.config.rowOnClickConfig.url] : "/ajax/production/status/get/mtrl_prdctmove_mgt_mpn"
        },
        lastGetParam : {
            param : {}
        },
    ...
    //버튼에 대한 Ajax 경로
    pageManager.gridManager.SetAjaxUrl(grid01.name, Const.MesButton.Search, "/ajax/production/status/get/mtrl_prdctmove_mgt");
...
//             lcr.whs_nm = document.search_frm.whs_nm.value;
            ...
            w2ui.grid02.records[w2ui.grid02.records.length - 1].from_loc_cd = grid01_records.stck_loc_cd;
            w2ui.grid02.records[w2ui.grid02.records.length - 1].from_loc_nm = grid01_records.stck_loc_nm;
        ...
        if(flag){
            w2confirm(Const.MesMsg.confirm)
                .yes(() => {
                    ...
                    let ajax_url = "/ajax/production/status/delete/mtrl_prdctmove_mgt";
    ...
    $("#hBtnB0005").on("click", function(){
        ...
        let rest_url = "/ajax/production/status/save/mtrl_prdctmove_mgt";
