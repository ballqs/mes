...
$(function () {
    ...
    let page_addr_name = "prd_mon_mgt";
    let pageManager = new GridPageManager(search_frm_id, btn_frm_id, page_addr_name);
    let pop_prt_nbr_cd = new Pop_prt_nbr_cd(pageManager, search_frm_id,"pop_prt_nbr_cd",{cd: [21,31]});
    ...
    //버튼에 대한 AJAX 경로
    pageManager.gridManager.SetAjaxUrl(grid01.name, Const.MesButton.Search, "/ajax/production/plan/get/prd_mon_mgt");
    pageManager.gridManager.SetAjaxUrl(grid01.name, Const.MesButton.Save, "/ajax/production/plan/save/prd_mon_mgt");
    ...
    pageManager.frmManager.AddSelectBoxInfo(search_frm_id,"name", "account_type", common.code, {up_cd: "account_type",cd: [21,31]}, "cd", "cd_nm", "", "전체");
