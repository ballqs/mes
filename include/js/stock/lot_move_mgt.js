$(function () {
    $('#grid1').w2grid({
        ...
        columns: [
            ...
            { field: 'text', caption: '이동창고<i class="fa fa-sort" aria-hidden="true"></i>', size: '100px', sortable: true, resizable: true },
            { field: 'text', caption: '이동위치<i class="fa fa-sort" aria-hidden="true"></i>', size: '100px', sortable: true, resizable: true },
        ],
        records: [
