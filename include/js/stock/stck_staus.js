...
$(function(){
    let grid1 = {
        ...
        columns: [
            ...
            { field: 'prt_nbr_cd', caption: '품번코드', size: '120px', sortable: true, resizable: true},
            ...
            { field: 'stck_whs_nm', caption: '창고', size: '150px', sortable: true, resizable: true},
            { field: 'stck_loc_cd', caption: '위치코드', size: '100px', sortable: true, resizable: true, hidden: true},
            { field: 'stck_loc_nm', caption: '위치', size: '150px', sortable: true, resizable: true},
    ...
    let grid2 = {
        ...
        columns: [
            ...
            { field: 'stck_loc_cd', caption: '위치코드', size: '100px', sortable: true, resizable: true, hidden: true},
            { field: 'stck_loc_nm', caption: '위치', size: '150px', sortable: true, resizable: true},
            { field: 'lotno', caption: 'LOT번호', size: '100px', sortable: true, resizable: true },
            { field: 'stck_wait_qty', caption: '검사대기수량', size: '100px', sortable: true, resizable: true, attr:"align=right" },
            { field: 'stck_qty', caption: '재고수량', size: '100px', sortable: true, resizable: true, attr:"align=right" },
            { field: 'stck_unit', caption: '재고단위', size: '100px', sortable: true, resizable: true, editable: {type: "select"}},
            // { field: 'remark', caption: '비고', size: '300px', sortable: true, resizable: true, editable: {type: 'text'}},
    ...
    //PK, 필수입력, ReadOnly 필드등록
     pageManager.gridManager.SetReadonlyFields(grid1.name, ["recid" ,"fact_cd", "prt_nbr_cd","prt_nbr_cd","prt_nbr_nm","spec","prt_nbr_grp_cd"
    ...
    //버튼에 대한 Ajax 경로
    pageManager.gridManager.SetAjaxUrl(grid1.name, Const.MesButton.Search, "/ajax/stock/stck_staus/get/stck_staus");
    ...
    //PK, 필수입력, ReadOnly 필드등록
     pageManager.gridManager.SetReadonlyFields(grid2.name, ["recid" ,"fact_cd","prt_nbr_cd","prt_nbr_nm","spec","prt_nbr_grp_cd"
    ...
    //버튼에 대한 Ajax 경로
    pageManager.gridManager.SetAjaxUrl(grid2.name, Const.MesButton.Search, "/ajax/stock/stck_staus/get/stck_staus_lot");
