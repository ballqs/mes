...
$(function () {
    ...
    let grid01 = {
        ...
        columnGroups: [
            ...
            { caption: '창고', master: true, span: 2 },
            { caption: '위치', master: true, span: 2 },
        ...
        rowOnClickConfig : {
            ...
            [Const.config.rowOnClickConfig.clickWhereFieldList] : ["fact_cd","prt_nbr_cd","stck_whs_cd","stck_loc_cd"],
            [Const.config.rowOnClickConfig.url] : "/ajax/stock/stck_mon_staus/get/prtnbr_inout"
        },
        lastGetParam : {
            param : {},
        },
    ...
    let grid02 = {
        ...
        columns: [
            ...
            { field: 'prt_nbr_nm', caption: '품번명', size: '100px', sortable: true, resizable: true},
            { field: 'spec', caption: '규격', size: '100px', sortable: true, resizable: true},
            { field: 'lotno', caption: 'LOTNO', size: '100px', sortable: true, resizable: true},
        ...
        rowOnClickConfig : {
            ...
            [Const.config.rowOnClickConfig.clickWhereFieldList] : ["fact_cd","prt_nbr_cd","lotno","stck_whs_cd","stck_loc_cd"],
            [Const.config.rowOnClickConfig.url] : "/ajax/stock/stck_mon_staus/get/lotno_inout"
        },
        lastGetParam : {
            param : {},
        },
    ...
    let grid03 = {
        ...
        columns: [
            ...
            { field: 'in_whs_cd', caption: '창고', size: '100px', sortable: true, resizable: true, hidden:true},
            { field: 'in_whs_nm', caption: '창고명', size: '100px', sortable: true, resizable: true},
            { field: 'in_loc_cd', caption: '위치', size: '100px', sortable: true, resizable: true, hidden:true},
            { field: 'in_loc_nm', caption: '위치명', size: '100px', sortable: true, resizable: true},
    ...
    let grid04 = {
        ...
        columns: [
            { field: 'recid', caption: 'NO', size: '50px', sortable: true, resizable: true,  style: 'text-align: right' },
            { field: 'fact_cd', caption: '공장', size: '100px', sortable: true, resizable: true},
            { field: 'out_whs_cd', caption: '창고', size: '100px', sortable: true, resizable: true, hidden:true},
            { field: 'out_whs_nm', caption: '창고명', size: '100px', sortable: true, resizable: true},
            { field: 'out_loc_cd', caption: '위치', size: '100px', sortable: true, resizable: true, hidden:true},
            { field: 'out_loc_nm', caption: '위치명', size: '100px', sortable: true, resizable: true},
    ...
    pageManager.gridManager.SetAjaxUrl(grid01.name, Const.MesButton.Search, "/ajax/stock/stck_mon_staus/get/sms_prt");
    ...
    pageManager.gridManager.SetAjaxUrl(grid02.name, Const.MesButton.Search, "/ajax/stock/stck_mon_staus/get/sms_lot");
    ...
    //폼 팝업 등록
    let caller_name1 = "btn_pop_prt_nbr_cd";
    let target_name1 = ["prt_nbr_cd","prt_nbr_nm"];
    pageManager.frmManager.AddPopupLink(search_frm_id, caller_name1, pop_prt_nbr_cd.ShowFormDialog, target_name1);
