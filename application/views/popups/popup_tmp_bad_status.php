...
<div style="display:none;" id="popup_tmp_bad_status" class="popPage">
    <form id="popup_tmp_bad_status_frm" name="popup_tmp_bad_status_frm" class="popForm">
        ...
        <div class="tablet">
            <div class="topWrap cf">
                ...
                <div class="title">불량내역조회</div>
                <div class="arrow arrowR" data-arrow="right"><a><span></span></a></div>
            </div>

            <div class="btnDiv cf">
                <div style="display:none"><a id="tmp_bad_status_search_btn" class="open_popup_btn opBtn" data-name="search">조회</a></div>
                <div><a class="open_popup_btn opBtn" data-name="del">삭제</a></div>
            ...
            <div class="mb_10">
                <div class="viewLine cf">
                    ...
                    <div class="view cf">
<!--                        <div>작업일자</div>-->
<!--                        <div class="viewDate cf">-->
<!--                            <input type="date" class="date1 text_c" name="date1" value="2020-08-05" readOnly>-->
<!--                            <div class="dateBtn" data-iname="date1"><span class="arrowU"></span><span class="arrowD"></span></div>-->
<!--                            <p class="fl" style="margin-left:14px;"> ~ </p><input type="date" class="date2 text_c" name="date2" value="2020-08-10" readOnly>-->
...
<!--                        </div>-->
            ...
            <div class="grid2 tabCont active" id="tab1">
                <table class="gridTable" id="table_tmp_bad_status">
                    <thead>
                        <tr>
                            <th>선택</th>
                            <th>입력시간</th>
...
<script type="module" src="/include/js/popups/popup_tmp_bad_status.js"></script>
