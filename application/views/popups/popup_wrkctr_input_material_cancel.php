<div style="display:none;" id="popup_wrkctr_input_material_cancel" class="popPage">
    <form id="popup_wrkctr_input_material_cancel_frm" name="popup_wrkctr_input_material_cancel_frm" class="popForm">
        ...
        <div class="tablet">
            <div class="topWrap cf">
                ...
                <div class="title">투입취소</div>
                <div class="arrow arrowR"><a><span></span></a></div>
            </div>

            <div class="btnDiv cf">
<!--                <div><a class="open_popup_btn opBtn" data-name="manual">수동 투입</a></div>-->
<!--                <div><a class="open_popup_btn opBtn" data-name="init">초기화</a></div>-->
                <div><a class="open_popup_btn opBtn" data-name="cancel">투입취소</a></div>
            ...
            <div class="grid3 tabCont active">
                <table class="gridTable" id="table_can_lot">
                    <thead>
                        <tr>
                            <th>선택</th>
                            <th>LOTNO</th>
...
<!--                        </tr>-->
            ...
            <div class="grid3 tabCont">
                <table class="gridTable" id="table_can_prt">
                    <thead>
                        <tr>
                            <th>투입품번</th>
<!--                            <th>LOTNO</th>-->
...
<script type="module" src="/include/js/popups/popup_wrkctr_input_material_cancel.js"></script>
