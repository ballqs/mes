<div style="display:none;" id="popup_result_status" class="popPage">
    <form id="popup_result_status_frm" name="popup_result_status_frm" class="popForm">
        ...
        <div class="tablet">
            ...
            <div class="grid2 tabCont active" id="tab1">
                <table class="gridTable" id="table_result_status">
                    <thead>
                    <tr>
                        <th>선택</th>
                        <th>설비</th>
...
<script type="module" src="/include/js/popups/popup_result_status.js"></script>
