<div style="display:none;" id="popup_bad_status" class="popPage">
    <form id="popup_bad_status_frm" name="popup_bad_status_frm" class="popForm">
...
<!--            </div>-->
            <div class="grid2 tabCont active" id="tab1">
                <table class="gridTable" id="table_bad_status">
                    <thead>
                        <tr>
                            <th>품번</th>
                            <th>품명</th>
...
<script type="module" src="/include/js/popups/popup_bad_status.js"></script>
