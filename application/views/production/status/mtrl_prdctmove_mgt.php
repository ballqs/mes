...
<form id="search_frm" name="search_frm">
    <div class="searchWrap cf">
        ...
        <div class="searchLine cf">
            ...
            <div class="boxW col-3 search">
                <p>출고창고/위치</p>
                <input type="text" name="out_whs_nm" value="생산창고" readonly style="background-color: #F5F5F5">
                <input type="hidden" name="out_whs_cd" value="W2100" readonly>
            </div>
            <div class="boxW col-3 search">
                <p>입고창고/위치</p>
                <input type="text" name="in_whs_nm" value="제품창고" readonly style="background-color: #F5F5F5">
                <input type="hidden" name="in_whs_cd" value="W3100" readonly>
...
<script type="module" src="/include/js/production/status/mtrl_prdctmove_mgt.js"></script>
